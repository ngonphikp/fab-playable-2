...
public class PlaySpine : MonoBehaviour {
    ...
    public UnityEvent<string, string> OnEvent => m_OnEvent;
    public UnityEvent<string> OnComplete => m_OnComplete;

    public void Play() {
        m_SkeletonAnimation.ChangeAnimation(m_Animation, m_Loop, true);
    }
