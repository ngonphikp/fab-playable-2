...
namespace Lean.Pool
{
	...
	public class LeanGameObjectPool : MonoBehaviour, ISerializationCallbackReceiver
	{
		...
		public bool Warnings { set { warnings = value; } get { return warnings; } } [FSA("Warnings")] [SerializeField] private bool warnings = false;
		...
		public bool HasClone(GameObject clone) {
