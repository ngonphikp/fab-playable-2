...
namespace Lean.Touch
{
	...
	public class LeanSelectableDrop : LeanSelectableByFingerBehaviour
	{
		...
		public UnityEvent OnFailureHandler { get { return onFailureHandler; } } [SerializeField] private UnityEvent onFailureHandler;
...
namespace Lean.Touch.Editor
{
	...
	public class LeanSelectableDrop_Editor : LeanEditor
	{
		protected override void OnInspector()
		{
			...
			var usedC = Any(tgts, t => t.OnFailureHandler.GetPersistentEventCount() > 0);
