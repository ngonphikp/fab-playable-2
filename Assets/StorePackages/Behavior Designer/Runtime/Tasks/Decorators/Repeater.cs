...
namespace BehaviorDesigner.Runtime.Tasks
{
    ...
    public class Repeater : Decorator
    {
        ...
        [Tooltip("Should the count be randomized?")]
        public SharedBool randomCount = false;
        [Tooltip("The minimum count if random count is enabled")]
        public SharedInt randomCountMin = 1;
        [Tooltip("The maximum count time if random count is enabled")]
        public SharedInt randomCountMax = 1;
        ...
        {
            if (randomCount.Value)
            {
                count = Random.Range(randomCountMin.Value, randomCountMax.Value + 1);
            }
        }
